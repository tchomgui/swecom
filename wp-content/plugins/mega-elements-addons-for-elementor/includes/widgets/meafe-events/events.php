...
class MEAFE_Events extends Widget_Base
{
    ...
    protected function render() {
        ...
        ?>
        <div class="meafe--event--main--wrapper layout-<?php echo $settings['becgs_events_layouts']; ?>">
                ...
                <?php if( $item['becgs_events_image']['id'] || $item['becgs_events_image']['url'] || ( $item['becgs_events_start_date_time'] && $settings['becgs_events_layouts'] == '3' ) ) { ?>
                    <div class="event--image--wrapper">
                        ...
                        <?php if( ! $item['becgs_events_image']['id'] && $item['becgs_events_image']['url'] ) { ?>
                            <img src="<?php echo esc_url( $item['becgs_events_image']['url'] ); ?>" alt="<?php echo ( $item['becgs_events_text'] ) ? $item['becgs_events_text'] : ''; ?>">
                        <?php } ?>
                        </figure>
                        <?php if( $item['becgs_events_start_date_time'] && $settings['becgs_events_layouts'] == '3' ) { ?>
                            <div class="month--details">
                                <span class="date"><?php echo date('j', strtotime( $item['becgs_events_start_date_time'] ) ); ?></span>
                                <span class="month"><?php echo date('M', strtotime( $item['becgs_events_start_date_time'] ) ); ?></span>
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
                        ...
                        <?php if(  $item['becgs_events_start_date_time'] && $item['becgs_events_end_date_time'] ) { ?>
                            <div class="meafe--event--time">
                                <span class="meafe--event--time-icon">
                                    ...
                                    <?php echo date('h:i  A', strtotime( $item['becgs_events_start_date_time'] ) ) . ' - ' . date('h:i  A', strtotime( $item['becgs_events_end_date_time'] ) ); ?>
                                </span>
                            </div>
                        <?php } ?>
