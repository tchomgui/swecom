...
class MEAFE_Clients extends Widget_Base
{
    ...
    public function get_style_depends() {
        return ['meafe-clients', 'owl-carousel'];
    }
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    ...
                    '{{WRAPPER}} .meafe-clients .meafe-grid-container:not(.owl-carousel)' => 'margin-left: -{{LEFT}}{{UNIT}}; margin-right: -{{RIGHT}}{{UNIT}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        <div class="meafe-clients meafe-gapless-grid">
            <div class="meafe-grid-container<?php echo $this->get_grid_classes( $settings ); ?><?php if ( $settings['bccgs_clients_show_carousel'] == true ) echo ' owl-carousel'; ?>">                
                <?php
