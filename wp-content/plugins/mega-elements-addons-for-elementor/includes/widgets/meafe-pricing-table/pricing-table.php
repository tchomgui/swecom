...
class MEAFE_Pricing_Table extends Widget_Base
{
    ...
    protected function render() {
        ...
        ?>
        <div class="meafe-pricing-table-container layout-<?php echo $settings['pricing_table_layouts']; ?>">
            ...
            <?php if ( 'yes' === $settings['show_ribbon'] && $settings['ribbon_title'] ) { ?>
                <?php
                    $classes = [
                        ...
                        'meafe-pricing-table-ribbon-' . $settings['ribbon_style'],
                        'meafe-pricing-table-ribbon-' . $settings['ribbon_position'],
                    ];
    ...
    protected function get_content_template() {
        ...
        #>
        <div class="meafe-pricing-table-container layout-{{{settings.pricing_table_layouts}}}">
