...
class MEAFE_Countdown extends Widget_Base
{
    ...
    protected function render( ) {
        ...
        <div id="countDownContiner-<?php echo esc_attr( $this->get_id() ); ?>" class="meafe-countdown-main meafe-countdown-separator-<?php echo $settings['bccgs_countdown_separator']; ?>" data-settings='<?php echo wp_json_encode( $countdown_settings ); ?>'>
