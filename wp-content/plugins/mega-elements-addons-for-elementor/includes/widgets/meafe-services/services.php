            ...
            foreach ( $settings['bscgs_services'] as $index => $service ) {
                ...
                <?php 
                    ...
                    <div class="meafe-service-text">
                        <?php
                        echo '<' . $settings['bssts_service_title_tag'] . ' class="meafe-title">'; 
                ...
                if ( $has_link && $service['bscgs_service_read_more'] ) {
                    ...
                    echo '<a class="meafe-readmore-link" ' . $this->get_render_attribute_string( $link_key ) . '>' . $service['bscgs_service_read_more'];
