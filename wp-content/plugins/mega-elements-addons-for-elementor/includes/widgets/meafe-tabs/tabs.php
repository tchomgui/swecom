    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'class' => ['meafe--tabs--wrapper', 'layout-' . $settings['btcgs_tabs_layout']],
                                ...
                                if ( $tab['btcgs_tabs_icon_type'] === 'icon' ) : ?>
                                    <?php if ( $tab_icon_is_new || $tab_icon_migrated ) {
                                        if ( isset( $tab['btcgs_tabs_title_icon_new']['value']['url'] ) ) {
                                            echo '<img src="' . $tab['btcgs_tabs_title_icon_new']['value']['url'] . '"/>';
                                        } else {
                                            echo '<i class="' . $tab['btcgs_tabs_title_icon_new']['value'] . '"></i>';
                                        }
                                    } else {
                                        echo '<i class="' . $tab['btcgs_tabs_title_icon'] . '"></i>';
                                    } ?>
                                <?php endif; ?>
                            <?php endif; ?> <span><?php echo $tab['btcgs_tabs_title']; ?></span>
                        </div>
                        <?php 
                        $tab_title_index++;
                    endforeach; ?>
