...
<div class="search-form-section">
	<button class="<?php echo esc_attr($class); ?> header-search-btn" data-modal-key="<?php echo esc_attr($key); ?>" data-id="search"    data-label="<?php echo $search_label_position[$device]; ?>" <?php echo rishi__cb_customizer_attr_to_html($attr); ?>>
